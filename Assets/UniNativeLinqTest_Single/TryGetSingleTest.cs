...
{
    [TestFixture]
    public class TryGetSingleTest
    {
        [Test]
        public void NullSourceWithoutPredicate()
        {
            int[] source = null;
            Assert.Throws<ArgumentNullException>(() => source.TryGetSingle(out var y));
        }
        ...
        {
            int[] source = null;
            Assert.Throws<ArgumentNullException>(() => source.TryGetSingle(out var y, x => x > 3));
        }
        ...
        public void NullPredicate()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => source.TryGetSingle(out var y, predicate));
        }
        ...
        {
            int[] source = { };
            Assert.IsFalse(source.TryGetSingle(out var y));
        }
        ...
        {
            int[] source = { 5 };
            Assert.IsTrue(source.TryGetSingle(out var y));
            Assert.AreEqual(5, y);
        }
        ...
        {
            int[] source = { };
            Assert.IsFalse(source.TryGetSingle(out var y, x => x > 3));
        }
        ...
        {
            int[] source = { 5 };
            Assert.IsTrue(source.TryGetSingle(out var y, x => x > 3));
            Assert.AreEqual(5, y);
        }
        ...
        public void EarlyOutWithoutPredicate()
        {
            ...
            Assert.IsFalse(query.TryGetSingle(out var y));
        }
        ...
        public void EarlyOutWithPredicate()
        {
            ...
            var query = source.Select(x => 10 / x);
            // We don't get as far as the third element - we die when we see the second
            Assert.IsFalse(query.TryGetSingle(out var y, x => true));
        }
    }
}
...
namespace UniNativeLinq.Tests
{
    ...
    public class TryGetMaxTest
    {
        ...
        {
            int[] source = null;
            Assert.Throws<ArgumentNullException>(() => source.TryGetMax(out var x));
        }
        ...
        public void NullInt32Selector()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => source.TryGetMax(out var x, selector));
        }
        ...
        {
            int[] source = { };
            Assert.IsFalse(source.TryGetMax(out var x));
        }
        ...
        {
            byte[] source = { };
            Assert.IsFalse(source.TryGetMax(out var y, x => (int)x));
        }
        ...
        public void SimpleSequenceInt32NoSelector()
        {
            ...
            Assert.IsTrue(source.TryGetMax(out var y));
        ...
        public void SequenceContainingBothInfinities()
        {
            ...
            Assert.IsTrue(source.TryGetMax(out var y));
            Assert.IsTrue(double.IsPositiveInfinity(y));
        }
        ...
        public void SequenceContainingNaN()
        {
            ...
            // Enumerable.TryGetMax thinks that infinity is more than NaN
            Assert.IsTrue(source.TryGetMax(out var y));
            Assert.IsTrue(double.IsPositiveInfinity(y));
            // Math.TryGetMax thinks that NaN is more than infinity

...
namespace UniNativeLinq.Tests
{
    ...
    public class TakeLastTest
    {
        ...
        {
            new TakeLastEnumerable<ThrowingEnumerable, ThrowingEnumerable.Enumerator, int>(new ThrowingEnumerable(), 10);
        }
        ...
        {
            int[] source = null;
            Assert.Throws<ArgumentNullException>(() => source.TakeLast(10));
        }

        [Test]
        public void NegativeCount()
        {
            Enumerable.Range(0, 5).TakeLast(-5).AssertSequenceEqual();
        }
        ...
        {
            Enumerable.Range(0, 5).TakeLast(3).AssertSequenceEqual(2, 3, 4);
        }

        [Test]
        public void CountEqualToSourceLength()
        {
            Enumerable.Range(0, 5).TakeLast(5).AssertSequenceEqual(0, 1, 2, 3, 4);
        }

        [Test]
        public void CountGreaterThanSourceLength()
        {
            Enumerable.Range(0, 5).TakeLast(100).AssertSequenceEqual(0, 1, 2, 3, 4);
        }
        ...
        public void OnlyEnumerateTheGivenNumberOfElements()
        {
            ...
            {
                foreach (var i in query.TakeLast(2))
                {
                }
            });
        }

...
namespace UniNativeLinq.Tests
{
    ...
    public class TakeWhileTest
    {
        ...
        {
            new TakeWhileEnumerable<ThrowingEnumerable, ThrowingEnumerable.Enumerator, int, PredicateGreaterThan>(new ThrowingEnumerable(), new PredicateGreaterThan(10));
        }
        ...
        {
            int[] source = null;
            Assert.Throws<ArgumentNullException>(() => source.TakeWhile(new PredicateGreaterThan(10)));
        }
        ...
        {
            int[] source = { 4, 3, 3, 5, 4, 4, 3 };
            source.TakeWhile(x => x > 4).AssertSequenceEqual();
        }

        [Test]
        public void PredicateMatchingSomeElements()
        {
            int[] source = { 4, 3, 3, 5, 4, 4 };
            source.TakeWhile(x => x < 5).AssertSequenceEqual(4, 3, 3);
        }
        ...
        {
            int[] source = { 4, 3, 3, 5, 4, 4 };
            source.TakeWhile(x => x < 100).AssertSequenceEqual(4, 3, 3, 5, 4, 4);
        }
    }
}